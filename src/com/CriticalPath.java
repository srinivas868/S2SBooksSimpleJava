...
public class CriticalPath {
    ...
    public static void main(String[] args) {
        ...
        Task start = new Task("Start", 0, true);
        Task D = new Task("D", 3, false, start);
        Task E = new Task("E", 4, false, D);
        Task I = new Task("I", 1, false, start);
        Task end = new Task("End", 0, true, E, I);
        allTasks.add(start);
        allTasks.add(D);
        allTasks.add(E);
        allTasks.add(I);
    ...
    public static class Task {
        ...
        public Task(String name, int cost, boolean ignore, Task... dependencies) {
            this.name = name;
            this.cost = cost;
    ...
    public static void print(Task[] tasks) {
        ...
        for (Task t : tasks) {
        	String output[] = t.toStringArray();
        	if(output[output.length-1].equalsIgnoreCase("Yes") && !t.ignore) {
        		System.out.format(format, (Object[]) output);
        	}
        }
    }
}